...
import { CustomLink, Main, Paragraph, Ul } from './styles';

export const TermsOfUsePage: React.FC = () => {
  return (
    <Main>
      <CustomLink href="/">Voltar para a página inicial</CustomLink>
      ...
      <Paragraph>
        ...
        interno da Bikube (&quot;Sistema&quot;) para todos os funcionários,
        colaboradores e afiliados autorizados (&quot;Usuário&quot;).
      </Paragraph>
      <section>
        ...
        <Paragraph>
          1.2. O acesso é pessoal, único e concedido pela Bikube após a sua
          contratação. Suas credenciais (registro e senha) são de sua exclusiva
          responsabilidade.
        </Paragraph>
      </section>
      <section>
